...
class TestErrorBoundary:
    @patch("dj_angles.regex_replacer._render_template")
    def test_missing(self, _render_template):
        _render_template.side_effect = _get_template_does_not_exist_exception()
